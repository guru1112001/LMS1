...
class CourseResource extends Resource
{
    ...
    protected static ?string $navigationIcon = 'icon-courses';
    //protected static ?string $navigationIcon = 'heroicon-o-squares-2x2';

    //protected static ?string $navigationGroup = 'Courses & Content';

    //protected static bool $shouldRegisterNavigation = Auth::user()->is_student;
    ...
    public static function getPages(): array
    {
        return [
            ...
            'lesson' => Pages\ViewLesson::route('/{record}/lesson'),
        ];
    }
